...
angular.module('app').controller('lifespanChartCtrl', ["$scope", "familyService", "authService", function ($scope, familyService, authService) {
...
angular.module('app').directive('lifespanChart', ["$parse", "$window", function ($parse, $window) {
	...
	return {
		...
		link: function link(scope, elem, attrs) {
			...
			var rscale = d3.scale.linear().domain([scope.minLifespan, scope.maxLifespan]).range([.5, 20]);
