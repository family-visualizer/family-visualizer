...
angular.module('app').controller('birthMonthCtrl', ["$scope", "$rootScope", function ($scope, $rootScope) {}]);
'use strict';
	...
	return {
		...
		link: function link(scope, elem, attrs) {
			...
			function generateDonut(data, genMultiplier) {
				...
				var arc = d3.svg.arc().outerRadius(80 - 10).innerRadius(80 - 70);

				var pie = d3.layout.pie().sort(null).value(function (d) {
					return d.population;
				});

				var svg = d3.select("body").append("svg").attr("width", width).attr("height", height).append("g").attr("transform", "translate(" + 30 + "," + 90 + ")");
