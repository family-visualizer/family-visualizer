angular.module('app').service('birthMonthService', [birthMonthService]);

function birthMonthService() {
	    ...
	    for (var i = 0; i < bigDataArray.length; i++) {
	        if (bigDataArray[i].birthDate) {
	            ...
	            if (birthDateArray.length === 3) {
	                ...
	                var birthMonth = "not available";
	            }
	        }
	        bigDataArray[i]["birthMonth"] = birthMonth;

	    }
	    this.addGenerationNumberToRelative(bigDataArray);
	}

	var myDataArray;

	this.addGenerationNumberToRelative = function(bigDataArray) {


	    for (var i = 0; i < bigDataArray.length; i++) {
	        if (bigDataArray[i].ascendancyNumber) {
	            if (bigDataArray[i].ascendancyNumber >= 2 && bigDataArray.ascendancyNumber < 4) {
	                bigDataArray[i]["generation"] = 0;
	            }
	...
	this.addMonthsToChartData = function(bigDataArray, chartData, compareMonthArray) {
		for(var i = 0; i < bigDataArray.length; i++) {
	...
	this.addBirthMonthToRelative(data);

	this.returnData = function() {
		return this.addMonthsToChartData(myDataArray, chartData, compareMonthArray);
	}

	this.dataset = this.returnData();

	console.log("this is dataset in service", this.dataset);


	//TOTAL BIRTHS PER MONTH LOGIC =============================================
	//TOTAL BIRTHS PER MONTH LOGIC =============================================
	//TOTAL BIRTHS PER MONTH LOGIC =============================================
	//TOTAL BIRTHS PER MONTH LOGIC =============================================

	let totalBirthsPerMonthPreObject = {
		  january: 0
		, february: 0
		, march: 0
		, april: 0
	...
	var bigDog = 0;
	this.addTotalBirthsPerMonth = function(dataset, t) {
	...
	//TOTAL BIRTHS PER MONTH VARIABLE
	this.totalBirthsPerMonth = this.addTotalBirthsPerMonth(this.dataset, totalBirthsPerMonthPreObject);


	//TOTAL BIRTHS PER GENERATION LOGIC ========================================
	//TOTAL BIRTHS PER GENERATION LOGIC ========================================
	//TOTAL BIRTHS PER GENERATION LOGIC ========================================
	//TOTAL BIRTHS PER GENERATION LOGIC ========================================

	let totalBirthsPerGenerationPreObject = {
		  generation1: 0
		, generation2: 0
		, generation3: 0
		, generation4: 0
	...
	this.addTotalBirthsPerGeneration = function(dataset, t) {
		for(var i = 0; i < dataset.generation1.length; i++) {
			t.generation1 += dataset.generation1[i];
		}
		for(var i = 0; i < dataset.generation2.length; i++) {
			t.generation2 += dataset.generation2[i];
		}
		for(var i = 0; i < dataset.generation3.length; i++) {
			t.generation3 += dataset.generation3[i];
		}
		for(var i = 0; i < dataset.generation4.length; i++) {
			t.generation4 += dataset.generation4[i];
		}
		for(var i = 0; i < dataset.generation5.length; i++) {
			t.generation5 += dataset.generation5[i];
		}
		for(var i = 0; i < dataset.generation6.length; i++) {
			t.generation6 += dataset.generation6[i];
		}
		for(var i =0; i < dataset.generation7.length; i++) {
			t.generation7 += dataset.generation7[i];
		}
		return t;
	}


	//TOTAL BIRTHS PER GENERATION VARIABLE
	this.totalBirthsPerGeneration = this.addTotalBirthsPerGeneration(this.dataset, totalBirthsPerGenerationPreObject);
